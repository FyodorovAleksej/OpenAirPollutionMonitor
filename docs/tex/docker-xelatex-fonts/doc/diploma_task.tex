...
% Alt + 0187 => »
    ...
    \begin{enumerate}[label=\textbf{\arabic*}, itemsep=1em,
      ...
      \begin{enumerate_nest_bold_num}
        ...
        \item Используемая файловая система: локальная, HDFS.
        \item Используемый сервис контейнеризации: Docker.
        \item Способ отображения информации: интерактивный документ Apache Zeppelin.
      ...
      \begin{enumerate_nest_bold_num}
        ...
        \item Программное средство для анализа. Схема структурная.
        \item Программное средство для анализа. Диаграмма классов.
        \item Отправка сообщения системы. Диаграмма последовательности.
        \item Обработка сообщения системы. Диаграмма последовательности.
        \item Интерактивный документ обработки сообщений в режиме реального времени. Схема программы.
      \end{enumerate_nest_bold_num}
