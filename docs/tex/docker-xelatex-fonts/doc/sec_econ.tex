...
\FPeval{\valTvRounded}{round(valTv, 2)}
...
Трудоёмкость описания задачи и исследования алгоритма решения может быть определена
...
Тогда на основании формулы~(\ref{eq:econ:Trz}) и расчётов ранее,
...
энергоустановок по мощности \num\valkis. Стоимость киловатт-часа электроэнергии на момент расчётов
...
\begin{equation}
  \label{eq:econ:Apk}
  \text{А}_\text{пк} = \text{Ц}_\text{пк}^\text{б} * \frac{\text{Н}_\text{пк}^\text{а}}{100},
\end{equation}
\begin{explanationx}
...
\begin{equation}
  \label{eq:econ:TSpk}
  \text{Ц}_\text{пк}^\text{б} = \text{Ц}_\text{пк} * k_\text{у} * k_\text{м},
\end{equation}
\begin{explanationx}
...
\begin{equation}
  \label{eq:econ:Rpk}
  \text{Р}_\text{пк} = \text{Ц}_\text{пк}^\text{б} * k_\text{ро},
\end{equation}
\begin{explanationx}
  \item[где] $ k_\text{ро} $ -- коэффициент, учитывающий затраты на ремонт и техническое обслуживание ПК.
\end{explanationx}

Подставив $ k_\text{ро} = \num\valkro $, найдём затраты на ремонт и техническое обслуживание ПК:
...
\begin{equation}
  \label{eq:econ:Apl}
  \text{А}_\text{пл} = \text{Ц}_\text{пл}^\text{б} * \frac{\text{Н}_\text{пл}^\text{а}}{100},
\end{equation}
\begin{explanationx}
...
\begin{equation}
  \label{eq:econ:TSplb}
  \text{Ц}_\text{пл}^\text{б} = S_\text{пк} * k_\text{д} * \text{Ц}_\text{пл},
\end{equation}
\begin{explanationx}
...
Годовые затраты на ремонт и содержание производственных площадей укрупнённо
могут быть определены по формуле:

\begin{equation}
  \label{eq:econ:Rpl}
  \text{Р}_\text{пл} = \text{Ц}_\text{пл}^\text{б} * k_\text{рэ},
\end{equation}
\begin{explanationx}
...
\begin{equation}
  \label{eq:econ:Rar}
  \text{Р}_\text{ар} = S_\text{пк} * k_\text{д} * k_\text{ар} * k_\text{комф}
  * k_\text{пов} * 12,
\end{equation}
\begin{explanationx}
...
{ \rub}/м\textsuperscript{2}. Коэффициент комфортности возьмём равным \num\valkkomf, поскольку
...
\begin{equation}
  ...
  \text{Р}_\text{ар} = \num\valSpk * \num\valkd * \num\valkar * \num\valkkomf
  * \num\valkpov * 12 \approx \num\valRar \text{ \rub}
\end{equation}

Годовой фонд времени работы ПК определяется исходя из режима её работы
и может быть рассчитан по формуле:

\begin{equation}
  \label{eq:econ:Fpk}
  \text{Ф}_\text{пк} = t_\text{сс} * T_\text{сг},
\end{equation}
\begin{explanationx}
...
Ввод исходных данных в ПК подразумевает ввод парольного слова, которое будет в дальнейшем анализироваться. Для определённости возьмём среднее количество знаков, набираемых с клавиатуры, в размере \num\valKz { }символов.
...
Для расчёта годовых затрат, связанных с эксплуатацией аналога,
необходимо определить время решения данной задачи на ПК.
...
\begin{equation}
  \label{eq:econ:Tza}
  \text{Т}_\text{за} = (T_\text{вва} + T_\text{ра} + T_\text{выва}) * \frac{1 + d_\text{пза}}{60}
\end{equation}

Ввод исходных данных в ПК в этом случае также подразумевает ввод парольного слова. Для определенности, возьмём эту
...
\begin{equation}
  ...
  T_\text{вва} = \frac{K_{za} * H_z}{100} = \frac{\num\valKza * \num\valHz}
  {100} \approx \num\valTvva
\end{equation}
...
На момент расчётов ставка налога на прибыль составляла \num\valSnp \%. Прирост прибыли
составит:
...
\begin{equation}
  \label{eq:econ:Kz}
  \text{К}_{\text{з}} = \text{Ц}_\text{пк}^\text{б} * \left( 1 - x *
  \frac{\text{Н}_\text{пк}^\text{а}}{100} \right) * \text{Т}_\text{з} *
