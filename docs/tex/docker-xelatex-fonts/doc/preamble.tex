...
\newcommand\sectioncentered{%
  \clearpage\@startsection {section}{1}%
    ...
    {-1em \@plus -1ex \@minus -.2ex}%
    {1em \@plus .2ex}%
    {\bfseries\pretolerance=10000\centering\normalfont\MakeUppercase}%
    }
\makeatother

% Зачем: отступ от номера до заголовка должен составлять 1 пробел.
% Для Times New Roman это приблизительно 0.5em
% See https://tex.stackexchange.com/questions/25989/spacing-in-headline-between-number-and-text for updating it for different packages
%% Номера всегда будут жирным
\makeatletter
\renewcommand*{\@seccntformat}[1]{\textbf{\csname the#1\endcsname}\hspace{0.5em}}
\makeatother
...
\fontdimen3\font=1000\fontdimen3\font
...
\renewenvironment{figure}{\vspace{1.5mm}\begin{oldfigure}[h]}{\vspace{1mm}\end{oldfigure}}
